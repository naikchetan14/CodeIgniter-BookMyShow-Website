<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <?php if (session('Roles') === 'admin' && session('isAdmin') === true): ?>
      <div>

        <a href="/admin/signin"><button type="button" class="btn btn-danger"><i class="fa-solid fa-right-to-bracket mx-1"></i>Sign in</button></a>
        <a href="/admin/register"><button type="button" class="btn btn-success"><i class="fa-solid fa-right-to-bracket mx-1"></i>Register</button></a>
        <a href="/admin/track/allusers"><button type="button" class="btn btn-primary"><i class="fas fa-running"></i>Track User</button></a>
    ...
    <?php elseif (session('Roles') === 'user' && session('isAdmin') === false): ?>
      <div>
